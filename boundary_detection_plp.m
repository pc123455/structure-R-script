...
for i=1:length(spec_ratio)
    ...
    plp_spec{i,1}=plp_feature{i,1}{1,2};
end
...
%     else
% 	annot.params = cellpush(annot.params, {'Cluster method', 'agglomerative (Matlab磗 clusterdata)'});
% 	ei_clustermethod = 'aggl';
%     end
    boundary_indices_bands{i}=[bounds_indices];
